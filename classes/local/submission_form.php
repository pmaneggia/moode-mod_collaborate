...
class submission_form extends \moodleform { // TODO why do we not extend moodleform_mod instead ???
    public function definition() {
        error_log('I have been defined!!! Ahahahah!');
        global $DB;
        $mform = $this->_form;
    ...
    function data_preprocessing(&$default_values) {
        error_log('I have been here!!! Ahahahah!');
